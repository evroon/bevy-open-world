...
docker exec -it adsb-clickhouse clickhouse-client --time --engine_file_skip_empty_files 1 --optimize_trivial_insert_select 0 --query "
...
SELECT
    ...
    icao, r, t, db_flags, no_reg_data, own_op, year, desc,
    lat, lon,
